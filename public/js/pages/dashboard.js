...
$(function () {
  ...
  'use strict';
	...
	var options = {
          series: [{
          name: 'Sucesso',
          data: [44, 55, 57, 56, 30, 42, 38, 56, 25]
        }, {
          name: 'Cancelamento',
          data: [3, 5, 2, 8, 7, 4, 6, 2, 8]
        }],
          chart: {
          type: 'bar',
          height: 220
        },
		colors:['#2a8853', '#fb3d4e'],
        plotOptions: {
          bar: {
            horizontal: false,
            columnWidth: '70%',
        ...
        xaxis: {
          categories: ['Jan', 'Fev', 'Mar', 'Mai', 'Jun', 'Jul', 'Ago', 'Set', 'Out'],
        },
		legend: {
          position: 'top',
		...
		var bar = new ProgressBar.Circle(progressbar1, {
		  ...
		  from: { color: '#2cc1d7', width: 1 },
		  to: { color: '#2cc1d7', width: 4 },
