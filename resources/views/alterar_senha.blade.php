...
<html lang="pt-br">
  <head>
    ...
    <title>Empório Naval - ResetPassword</title>
					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded30 shadow-lg">
							...
							<div class="p-40">
                                ...
                                @endif
								<form action="{{ route('confirm-alterar-senha', ['token' => $token]) }}" method="post">
									...
									<div class="form-group">
									  ...
									  <div class="row">
                                        ...
                                        <div class="col-12 text-center">
										  <button type="submit" class="btn mt-10" style="background: #162647; color: #FFF;">Salvar Senha</button>
										</div>
									  </div>
								</form>
							</div>
